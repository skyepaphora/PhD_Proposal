...
```{r}
png(filename = paste0("ICASSP/PaperPlots/sx_",my.type,"_B",B,"_true",".png"),
width = 6.5, height = 5, units = "in", res = 200, bg = skrown$salt, pointsize = 10)
# ---------------------------------------------------------------------------------

    # Prep
    par(mar = c(8,4.4,4.4,2), oma = c(2.5,0,0,0))
