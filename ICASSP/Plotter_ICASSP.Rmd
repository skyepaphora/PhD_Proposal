...
gt <- ct^2
zlim <- 0:1 # range(normy(tru$xtf), normy(cbc$mean), normy(ssx), normy(cbc.smooth), normy(cbc.samp))
```

# GEST \& YEST

```{r}
png(filename = paste0("ICASSP/PaperPlots/gyf_",my.type,"_B",B,".png"),
width = 5.5, height = 7, units = "in", res = 200, pointsize = 10)
# ---------------------------------------------------------------------------------

    # Prep
    par(mfrow = c(2,1), mar = c(4,3.6,4,0))
...
```{r TRUE-SGRAM}
png(filename = paste0("ICASSP/PaperPlots/sx_",my.type,"_smooths",".png"),
width = 5.5, height = 12, units = "in", res = 200, pointsize = 10)
# ---------------------------------------------------------------------------------

    # Prep
    par(mfrow = c(3,1), mar = c(4.4,4.4,4.4,0)) #, oma = c(2.5,0,0,0))
...
```{r}
png(filename = paste0("ICASSP/PaperPlots/sx_",my.type,"_B",B,"_raws",".png"),
width = 5.5, height = 8, units = "in", res = 200, pointsize = 10)
# ---------------------------------------------------------------------------------

    # Prep
    par(mfrow = c(2,1), mar = c(4.4,4.4,4.4,0)) #, oma = c(2.5,0,0,0))
    zlim <- range(normy(tru$xtf), normy(cbc$mean), normy(ssx))
