...
# Simulate FUNCTION
ccbc <- function(type = "noise", ct = rep(1,N), ct2 = rep(1,N), M = 100, seed = 0, B = 100, ar2 = c(0.5,-0.5), ar2.2 = c(0.7,-0.3)){ 
  ...
  # Save true vals
  tru <- list(zf.true, ztf.true, yf.true, ytf.true, yf2.true, ytf2.true, xtf.true, xtf2.true)
  names(tru) <- c("zf", "ztf", "yf", "ytf", "yf2", "ytf2", "xtf", "xtf2")
...
```{r}
my.type <- "GUMP"
trial <- ccbc(type = my.type, ct = ct, ct2 = ct2, M = 100, seed = 17, B = B)
```
