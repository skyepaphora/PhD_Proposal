...
```{r}
load("Data/B200_c1_UMP_full.RData")
# load("Data/B200_c3_UMP_full.RData")
# load("Data/B300_c1_UMP_full.RData")
# load("Data/B300_c3_UMP_full.RData")
```
...
```{r save2}
save.image(paste0("Data/","B",B,"_",cc,"_",my.type,"_full_S-2bc.RData"))
rm(asx.full, ssx.full); gc()
save.image(paste0("Data/","B",B,"_",cc,"_",my.type,"_reduced_S-2bc.RData"))
```
