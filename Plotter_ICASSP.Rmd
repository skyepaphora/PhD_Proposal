...
load("PaperData/UMP_B200_full_G.RData")
...
```{r}
png(filename = paste0("PaperPlots/g_",my.type,"_B",B,".png"),
...
```{r}
png(filename = paste0("PaperPlots/yf_",my.type,"_B",B,".png"),
width = 12, height = 8, units = "in", res = 200, bg = skrown$salt, pointsize = 10)
# ---------------------------------------------------------------------------------
    ...
    # --- True sy
    splot(Fs, tru$yf , type = "l", ylim = lim, labs = 0, lwd = 2)
...
```{r}
png(filename = paste0("PaperPlots/yf_",my.type,"_B",B,"_true_",".png"),
width = 12, height = 8, units = "in", res = 200, bg = skrown$salt, pointsize = 10)
# ---------------------------------------------------------------------------------
    ...
    # --- Azadeh's sy
    image(Fs, t, t(normy(asx)), zlim = zlim,
    xlab = "", ylab = "", las = 1, col = tim.colors()); sox(); gc()
