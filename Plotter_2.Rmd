...
## --- Data (choose 1) ----------------------------- ##
# load("FinalData/UMP_B200_reduced_S.RData")

## --- Common z-axis limits
zlim <- 0:1 

## --- sgram legend placement
leggo <- list(single = c(0.92,0.95,0.11,0.916))
...
# png(filename = paste0("FinalPlots/sx_",my.type,"_B",B,"_smooths3",".png"),
...
# png(filename = paste0("FinalPlots/sx_",my.type,"_B",B,"_smooths2",".png"),
# width = 5.44, height = 7, units = "in", res = 200, pointsize = 10)
# # ---------------------------------------------------------------------------------
# 
# 
...
png(filename = paste0("FinalPlots/sx_",my.type,"_true",".png"),
width = 7, height = 4, units = "in", res = 200, pointsize = 10)
# ---------------------------------------------------------------------------------
...
## --------- TRUE --------- ##
    ...
    image.plot(legend.only = TRUE, legend.lab = "Power", zlim = 0:1,
           legend.line = 0.5, legend.cex = 1, # Single
...
## --------- MEAN --------- ##
png(filename = paste0("FinalPlots/sx_",my.type,"_B",B,"_smooth_mean",".png"),
width = 7, height = 4, units = "in", res = 200, pointsize = 10)
# ---------------------------------------------------------------------------------
...
## --------- SAMPLE --------- ##
png(filename = paste0("FinalPlots/sx_",my.type,"_B",B,"_smooth_sample",".png"),
width = 7, height = 4, units = "in", res = 200, pointsize = 10)
# ---------------------------------------------------------------------------------
    ...
    xlab = "", ylab = "", las = 1, col = tim.colors()); sox(); gc()
    slab("Smoothed 2-BC Spectrogram", "Single Simulation", "Frequency", "Time")
    image.plot(legend.only = TRUE, legend.lab = "Power", zlim = 0:1,
           legend.line = 0.5, legend.cex = 1, # Single
           smallplot  = leggo$single)
...
```{r}
png(filename = paste0("FinalPlots/latticePlots/sx_",my.type,"_B",B,"_raws",".png"),
width = 5.44, height = 7, units = "in", res = 200, pointsize = 10)
# ---------------------------------------------------------------------------------
# Prep 2
par(mfrow = c(2,1), mar = c(4.2,4,4.2,0)) #, oma = c(2.5,0,0,0))
...
# png(filename = paste0("FinalPlots/sx_",my.type,"_B",B,"_raw_mean",".png"),
# width = 7, height = 4, units = "in", res = 200, pointsize = 10)
# # ---------------------------------------------------------------------------------
# #
# # Prep 1
...
# # ------------ SAMPLE
# 
# png(filename = paste0("FinalPlots/sx_",my.type,"_B",B,"_raw_sample",".png"),
# width = 7, height = 4, units = "in", res = 200, pointsize = 10)
# # ---------------------------------------------------------------------------------
# 
# # Prep 1
